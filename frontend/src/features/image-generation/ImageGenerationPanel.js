  ...
  return (
    <div className="feature-panel image-generation-panel-root">
      ...
      <div className="content-grid single-column">
        <article className="tool-card image-generation-workspace-card">
          <div className="image-generation-top-head">
            <div>
          ...
          <div className="image-generation-layout">
            <div className="image-generation-form-panel">
              <textarea
            ...
            <div className="image-generation-result-panel">
              <div className="image-generation-result-copy">
