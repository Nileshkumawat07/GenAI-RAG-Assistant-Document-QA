...
class User(Base):
    ...
    management_granted_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    management_granted_by_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    management_suspended_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    management_suspended_by_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    account_locked: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    locked_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    locked_by_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    reactivated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    reactivated_by_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    force_password_reset: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    archived_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    archived_by_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    merged_into_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    last_login_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    admin_2fa_required: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
