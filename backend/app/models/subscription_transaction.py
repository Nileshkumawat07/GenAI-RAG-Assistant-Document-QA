...
class SubscriptionTransaction(Base):
    ...
    refund_status: Mapped[str | None] = mapped_column(String(40), nullable=True, index=True)
    dispute_status: Mapped[str | None] = mapped_column(String(40), nullable=True, index=True)
    retry_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    billing_admin_note: Mapped[str | None] = mapped_column(String(255), nullable=True)
